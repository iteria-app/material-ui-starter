...
import {
  filterValueFromDataGrid,
  filterColumnFieldFromDataGrid,
} from '../../material-ui/dataTable/filter'

export interface OperatorTypesValues {
  dataGrid: string
  graphQl: object
}

export const getNumberFilterOperator = (filter: GridFilterModel) => {
  const filterValue: string = filterValueFromDataGrid(filter)
...
export const getStringFilterOperator = (filter: GridFilterModel) => {
  const filterValue: string = filterValueFromDataGrid(filter)
  const operatorValues: OperatorTypesValues[] = [
    {
      dataGrid: 'contains',
...
export const getDateFilterOperator = (filter: GridFilterModel) => {
  const filterValue: string = filterValueFromDataGrid(filter)
  const filterColumnField = filterColumnFieldFromDataGrid(filter)
...
export const getBooleanFilterOperator = (filter: GridFilterModel) => {
  const filterValue: string = filterValueFromDataGrid(filter)
  const operatorValues: OperatorTypesValues[] = [
    {
      dataGrid: 'is',
