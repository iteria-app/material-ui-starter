...
function iteriaLowcode(options) {
  ...
  console.log(process.env.VITE_HASURA_GRAPHQL_ENDPOINT);
  if (injectLowcode)
    process.env = __spreadProps(__spreadValues({}, process.env), {
      ...
      VITE_GRAPHQL_ENDPOINT: process.env.VITE_HASURA_GRAPHQL_ENDPOINT
    });
  let injectedEnvs = {};
  ...
  console.log(process.env.VITE_GRAPHQL_ENDPOINT, process.env.VITE_HASURA_GRAPHQL_ENDPOINT);
  const iteriaScript = __spreadProps(__spreadValues(__spreadValues(__spreadValues({
    ...
    graphQLEndpoint: (_d = (_c = options.graphQLEndpoint) != null ? _c : process.env.VITE_GRAPHQL_ENDPOINT) != null ? _d : process.env.VITE_HASURA_GRAPHQL_ENDPOINT
  } : {}), options.graphQLSecret ? { graphQLSecret: options.graphQLSecret } : {}), options.features ? { features: options.features } : {}), {
