...
export declare const loadIntrospection: (options?: {
    viewMessage: boolean;
}) => Promise<any>;
...
export declare const handleRemoveFormColumn: (el: HTMLElement, type: ElementHighlightMessageType) => Promise<void>;
export declare const handleIconClick: (window: Window, el: HTMLElement, type: ElementHighlightMessageType) => void;
export declare const handleAddField: (window: Window, type: ElementHighlightMessageType, event: CustomEvent) => Promise<void>;
...
export declare const handleViewERD: (el: HTMLElement, event: CustomEvent) => Promise<void>;
