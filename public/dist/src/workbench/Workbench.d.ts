...
export declare class DevWorkbench implements CodeRW, CodeDir {
    ...
    readDirectoryContent(path: string, files: DirectoryFiles[]): Promise<DirectoryFiles[]>;
    readFile(path: string, encoding?: string): Promise<string>;
    readDirectory(path: string, extensions?: readonly string[], exclude?: readonly string[], include?: readonly string[], depth?: number): Promise<DirectoryFiles[]>;
